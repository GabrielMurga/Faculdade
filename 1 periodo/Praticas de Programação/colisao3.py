...
def update(dt):
    ...
    if keys[pygame.K_LEFT]:
       dx_player= -(player1["speed"] * dt)
    
    if keys[pygame.K_RIGHT]:
       dx_player=  (player1["speed"] * dt)
    
    if keys[pygame.K_UP]:
       dy_player= -(player1["speed"] * dt)
    ...
    if check_circular_collision(player1["x"], player1["y"], player1["raio"], 
                       circle2["x"], circle2["y"], circle2["raio"]):
        player1["collided"] = True
        circle2["collided"] = True
    else:
        circle2["collided"] = False
...
def draw_screen(screen):
    ...
    color_circle2 = (255,255,255)
    if circle2["collided"] == True:
        color_circle2 = (0,255,0)

    pygame.draw.circle(screen,color_circle2, (circle2["x"], circle2["y"]), circle2["raio"])
    ...
    pygame.draw.circle(screen, color_player, (player1["x"], player1["y"]), player1["raio"])
